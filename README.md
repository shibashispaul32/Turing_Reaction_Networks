...
Estimated time to install run 10 sample simulations for reproducing Fig 2B: 30min.
Estimated time to install run numerical continuations for a small randomized parameter set (100): 2min.
Estimated time to install run numerical continuations for a large randomized parameter set (10000): 2.5hrs.
